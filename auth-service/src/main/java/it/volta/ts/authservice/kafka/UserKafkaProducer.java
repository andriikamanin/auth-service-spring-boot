...
import it.volta.ts.authservice.dto.UserEmailChangedEvent;
...
public class UserKafkaProducer {
    ...
    public void sendUserEmailChangedEvent(UUID userId, String newEmail) {
        kafkaTemplate.send("user.emailChanged", UserEmailChangedEvent.builder()
                .userId(userId)
                .newEmail(newEmail)
                .build());
    }
